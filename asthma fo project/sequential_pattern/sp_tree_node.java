...
public class sp_tree_node
{
	public sp_tree_node PARENT=null;
	public HashMap<String,sp_tree_node> CHILDREN=new HashMap<String,sp_tree_node>();
	...
	public sp_tree_node(String t)
	{		
		CONTENT=t;
	}
	
	public sp_tree_node(String t,sp_tree_node p)
	{
		PARENT=p;
		CONTENT=t;
	}
	...
	public void initial_for_prediction()
	{
		try
		{
			...
			while(ir.hasNext())
			{
				sp_tree_node temp_node=(sp_tree_node)CHILDREN.get((String)ir.next());
				temp_node.initial_for_prediction();
			}
		}
		catch(Exception e)
		{
			System.out.println("sp_tree_node initial_for_prediction exception:"+e);
		}
	}
...
//			Vector<String> remove_set=new Vector<String>();
			while(ir.hasNext())
			{
				...
				sp_tree_node temp_node=(sp_tree_node)CHILDREN.get(temp_key);
...
//				CHILDREN.remove((String)remove_set.get(i));
		...
		{
			System.out.println("sp_tree_node remove_redundancy exception:"+e);
		}
		return result;
	}
        ...
        private String find_max_key(HashMap<String,Double> c)
        {
                ...
                {
                        System.out.println("sp_tree_node find_max_key exception:"+e);
                }
                return result;
        }
	...
	public boolean path_build_with_class_score(Vector<String> a,String cl,double s)
	{
		try
		{
			...
			sp_tree_node temp_node=null;
			if(!CHILDREN.containsKey(temp))
			{
				temp_node=new sp_tree_node(temp,this);
				temp_node.LAYER=this.LAYER+1;
				CHILDREN.put(temp,temp_node);
			}
			else
				temp_node=(sp_tree_node)CHILDREN.get(temp);
			
			return temp_node.path_build_with_class_score(a,cl,s);
		}
		catch(Exception e)
		{
			System.out.println("sp_tree_node build_path exception:"+e);
		}
		return false;		
	}
	...
	private double sum_of_score()
	{
		...
		{
			System.out.println("sp_tree_node sum_of_score exception:"+e);
		}
		return result;
	}	
	...
	private double get_confidence(String key)
	{
		...
		{
			System.out.println("sp_tree_node get_confidence exception:"+e);
		}
		return result;
	}
        ...
        public boolean pattern_trace_for_length(Vector<String> a,int index,HashMap<String,Double> cs,int tn,String pp)
        {
			...
			//double tts=get_gainratio()*get_confidence(temp_key);
                        ...
                        else
                        {
                                ...
                                else
                                {
                                        ...
                                        for(int i=index;i<a.size();i++)
                                        {
                                                ...
                                                if(CHILDREN.containsKey(temp))
                                                {
                                                        boolean temp_b=((sp_tree_node)CHILDREN.get(temp)).pattern_trace_for_length(a,(i+1),cs,tn,pp+temp+",");
                ...
                {
                        System.out.println("sp_tree_node pattern_trace_for_length exception:"+e);
                }
                return result;
        }
        ...
        public boolean pattern_trace_for_all_score(Vector<String> a,int index,HashMap<String,Double> cs,int tn,String pp)
        {
                        ...
                        else
                        {
                                ...
                                else
                                {
                                        ...
                                        for(int i=index;i<a.size();i++)
                                        {
                                                ...
                                                if(CHILDREN.containsKey(temp))
                                                {
                                                        boolean temp_b=((sp_tree_node)CHILDREN.get(temp)).pattern_trace_for_all_score(a,(i+1),cs,tn,pp+temp+",");
                                                        result=result || temp_b;
                                                        if(temp_b)
                                                                match_list.add(temp);
                                                }
                ...
                {
                        System.out.println("sp_tree_node pattern_trace_for_all_score exception:"+e);
                }
                return result;
        }
...
//							ts+=tts;
			...
			else
			{
				...
				else
				{
					...
					for(int i=index;i<a.size();i++)
					{
						...
						if(CHILDREN.containsKey(temp))
						{
							boolean temp_b=((sp_tree_node)CHILDREN.get(temp)).pattern_trace_for_class_score(a,(i+1),cs,tn,pp+temp+",");
							result=result || temp_b;
							if(temp_b)
								match_list.add(temp);
						}
		...
		{
			System.out.println("sp_tree_node pattern_trace exception:"+e);
		}
		return result;
	}	
	...
	public boolean pattern_trace_for_length_x_gainratio(Vector<String> a,int index,HashMap<String,Double> cs,int tn,String pp)
	{
			...
			else
			{
				...
				else
				{
					...
					for(int i=index;i<a.size();i++)
					{
						...
						if(CHILDREN.containsKey(temp))
						{
							boolean temp_b=((sp_tree_node)CHILDREN.get(temp)).pattern_trace_for_length_x_gainratio(a,(i+1),cs,tn,pp+temp+",");
							result=result || temp_b;
							if(temp_b)
								match_list.add(temp);
						}
		...
		{
			System.out.println("sp_tree_node pattern_trace_for_length_x_gainratio exception:"+e);
		}
		return result;
	}
	...
	private double get_gainratio()
	{
		...
		{
			System.out.println("sp_tree_node get_gainratio exception:"+e);
		}
		return result;
	}
...
//						tts=gr;
			...
			else
			{
				...
				else
				{
					...
					for(int i=index;i<a.size();i++)
					{
						...
						if(CHILDREN.containsKey(temp))
						{
							boolean temp_b=((sp_tree_node)CHILDREN.get(temp)).pattern_trace_for_class_score_x_gainratio(a,(i+1),cs,tn,pp+temp+",");
							result=result || temp_b;
							if(temp_b)
								match_list.add(temp);
						}
	...
	public boolean pattern_trace_for_sn(Vector<String> a,int index,Vector<Integer> sn_set)
	{
		...
		{			
			...
			for(int i=index;i<a.size();i++)
			{
				...
				if(CHILDREN.containsKey(temp))
				{
					boolean temp_b=((sp_tree_node)CHILDREN.get(temp)).pattern_trace_for_sn(a,(i+1),sn_set);
					if(temp_b)
						match_list.add(temp);
				}
			}
	...
	public boolean path_build(String a)
	{
		try
		{
			...
			{
				CHILDREN.put(a,new sp_tree_node(a,this));
				return true;
			}
			else
				return false;
	...
	public boolean pattern_trace_for_counting(Vector<String> a,int index,int cn)
	{
			...
			else
			{
				...
				else
				{
					...
					for(int i=index;i<a.size();i++)
					{
						...
						if(CHILDREN.containsKey(temp))
						{
							boolean temp_b=((sp_tree_node)CHILDREN.get(temp)).pattern_trace_for_counting(a,(i+1),cn);
							result=result || temp_b;
							if(temp_b)
								match_list.add(temp);
						}
		...
		{
			System.out.println("sp_tree_node pattern_trace_for_counting exception:"+e);
		}
		return result;
	}
			...
			else
			{
				...
				else
				{
					...
					for(int i=index;i<a.size();i++)
					{
						...
						if(CHILDREN.containsKey(temp))
						{
							boolean temp_b=((sp_tree_node)CHILDREN.get(temp)).pattern_trace(a,(i+1));
							result=result || temp_b;
							if(temp_b)
								match_list.add(temp);
						}
	...
	public boolean extend_all_leaves()
	{
		...
		try
		{
			...
			{
				sp_tree_node temp_node=(sp_tree_node)CHILDREN.get(all_child.next());
				level2_flg=level2_flg&&temp_node.is_leaf();
			}
			if(level2_flg)
			{
				if(CHILDREN.size()<1)	//To avoid the node without children
					result=false;
				else
				{
					...
					{
						sp_tree_node temp_node=(sp_tree_node)CHILDREN.get(temp_set.get(i));
...
//				}
		...
		{
			System.out.println("sp_tree_node extend_all_leaves exception:"+e);
		}
		return result;
	}
...
//				}
		...
		{
			System.out.println("sp_tree_node extend_all_leaves_without_repeat exception:"+e);
		}
		return result;
	}	
	...
	public void clear_all_count()
	{
		try
		{
			...
			if(!is_leaf())
			{
				...
				while(ir.hasNext())
				{
					((sp_tree_node)CHILDREN.get((String)ir.next())).clear_all_count();
				}
			}
		}
		catch(Exception e)
		{
			System.out.println("sp_tree_node clear_all_count exception:"+e);
		}
	}
	...
	public int add_all(Vector<Vector<String>> a)
	{
		...
		{
			System.out.println("sp_tree_node add_all exception:"+e);
		}
	...
	public void remove_all()
	{
		...
		{
			System.out.println("sp_tree_node remove_all exception:"+e);
		}
	}
	...
	public boolean pattern_trace_for_sn_without_just(Vector<String> a, int index)
	{
		...
		{			
			...
			for(int i=index;i<a.size();i++)
			{
				...
				if(CHILDREN.containsKey(temp))
				{
					boolean temp_b=((sp_tree_node)CHILDREN.get(temp)).pattern_trace_for_sn_without_just(a,(i+1));
					if(temp_b)
						match_list.add(temp);
					result=result||temp_b;
				}
		...
		{
			System.out.println("sp_tree_node pattern_trace_for_sn_without_just exception:"+e);			
		}
		return false;
	}
}
